...
void n_intersect(vector<vector<int>> points, int iterations)
{
    ...
    if (iterations > 0)
    {
        ...
        //Adiciona o ponto actual ao vector test para se poder verificar na proxima iteracao
        test.push_back(p1);
        test.push_back(p2);

        //para verificar se ja nao e a primeira vez
        first++;
        //diminuir o numero de iteracoes
        iterations--;
        //para correr aos "pares" (de 2 em 2)
        ind = ind + 2;
